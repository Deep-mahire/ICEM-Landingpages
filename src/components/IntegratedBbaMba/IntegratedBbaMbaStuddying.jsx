  ...
  return (
    <div className="flex flex-col md:flex-row px-8 md:px-16 py-6 poppins-regular">
      ...
      <div className="w-full md:w-[70%] pr-0 md:pr-8" data-aos="fade-right">
        ...
        <h1 className="text-2xl font-semebold text-[#018697] ">Integrated BBA and MBA</h1>
        ...
        <div className="grid grid-cols-2 grid-rows-3 gap-2">
          ...
          <div className="bg-white p-4 shadow-lg shadow-blue-500/50 flex justify-between items-center rounded-lg" data-aos="zoom-in">
            <span className="flex flex-col md:flex-row items-center">
              <FaStar className="text-[#018697] mr-4 text-4xl" />
          ...
          <div className="bg-white p-4 shadow-lg shadow-blue-500/50 flex justify-between items-center rounded-lg" data-aos="zoom-in">
            <span className="flex flex-col md:flex-row items-center">
              <FaUsers className="text-[#018697] mr-4 text-4xl" />
          ...
          <div className="bg-white p-4 shadow-lg shadow-blue-500/50 flex justify-between items-center rounded-lg" data-aos="zoom-in">
            <span className="flex flex-col md:flex-row items-center">
              <FaBuilding className="text-[#018697] mr-4 text-4xl" />
          ...
          <div className="bg-white p-4 shadow-lg shadow-blue-500/50 flex justify-between items-center rounded-lg" data-aos="zoom-in">
            <span className="flex flex-col md:flex-row items-center">
              <FaLaptop className="text-[#018697] mr-4 text-4xl" />
          ...
          <div className="bg-white p-4 shadow-lg shadow-blue-500/50 flex justify-between items-center rounded-lg" data-aos="zoom-in">
            <span className="flex flex-col md:flex-row items-center">
              <FaGraduationCap className="text-[#018697] mr-4 text-4xl" />
          ...
          <div className="bg-white p-4 shadow-lg shadow-blue-500/50 flex justify-between items-center rounded-lg" data-aos="zoom-in">
            <span className="flex flex-col md:flex-row items-center">
              <FaChartLine className="text-[#018697] mr-4 text-4xl" /> {/* New Icon */}
